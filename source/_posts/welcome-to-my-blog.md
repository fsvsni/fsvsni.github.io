...
技术栈
KnowForge RAG Platform — 系统讲义¶
欢迎！这是一套基于 LangChain + Milvus Hybrid Search 构建的 KnowForge RAG Platform 20 讲系统课程，并额外提供第 0 章 Mini RAG 课前体验。

讲义版本：V1.0 封版讲义，最近更新：2026-07-06。若页面内容与源码不一致，请重新运行 python -m mkdocs build --strict 后刷新浏览器缓存。
...
推荐学习节奏¶
阶段	时长	内容	对应讲次
课前体验	1 天	用 AI 编程工具生成并跑通一个简易 RAG，先看见完整流程	第 0 章
...
快速导航¶
课程大纲与学习路线 — 第 0 章 + 20 讲主体结构和推荐学习顺序
第 0 章：Vibe Coding 入门实训 — 先学需求拆解、分阶段生成、测试和调试，再用 Mini RAG 完成一次完整实训
